...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
	...
	public void test_fahrenheitEnCelsius() {
		...
		//added
		assertEquals("   700 °F -> 371.1 °C ?", 371.1, question1.FahrenheitCelsius.fahrenheitEnCelsius(700), 0.1);
		assertEquals(" -4050 °F -> -2267.7 °C ?", -2267.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(-4050), 0.1);
	}
